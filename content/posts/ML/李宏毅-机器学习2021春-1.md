...
$$
\frac{\partial L}{\partial w}|_{w=w^{0}, b=b^{0}} \quad w^{1} \leftarrow w^{0}-\eta \frac{\partial L}{\partial w}|_{w=w^{0}, b=b^{0}} \\a\frac{\partial L}{\partial b}|_{w=w^{0}, b=b^{0}} \quad b^{1}  \leftarrow b^{0}- \eta \frac{\partial L}{\partial b}|_{w=w^{0}, b=b^{0}}
$$
